...
void temp(int particleNumber)
{
	for (int i = 0; i < particleNumber; i++) {
		particles.push_back(new Particle(XRandom(),1000,0));
	}
}
...
int main(int argc, char** argv)
{
	...
	t_particle1 = TextureManager::Inst()->LoadTexture("C:/Users/Fab/Desktop/XD/Computacion Grafica/FINAL/Models/raindrop1.png", GL_BGRA_EXT, GL_RGBA);
	t_particle2 = TextureManager::Inst()->LoadTexture("C:/Users/Fab/Desktop/XD/Computacion Grafica/FINAL/Models/raindrop2.png", GL_BGRA_EXT, GL_RGBA);
	t_particle3 = TextureManager::Inst()->LoadTexture("C:/Users/Fab/Desktop/XD/Computacion Grafica/FINAL/Models/raindrop3.png", GL_BGRA_EXT, GL_RGBA);
	t_particle4 = TextureManager::Inst()->LoadTexture("C:/Users/Fab/Desktop/XD/Computacion Grafica/FINAL/Models/raindrop4.png", GL_BGRA_EXT, GL_RGBA);
...
void GenerateParticles(double dt,int particleNumber) {
	...
	for (itP = particles.begin(); i<particleNumber; itP++) {
		if ((*itP)->getT() > 0.0) {
            ...
            (*itP)->restartParticle(XRandom(),1000,0);
			//delete(*itP);
